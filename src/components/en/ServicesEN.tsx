  ...
  const services = [
    {
      ...
      description: 'Intelligent AI that screens prospects, qualifies them, and transfers to your sales team.',
      roi: 'Higher conversion',
      metric: '24/7 available',
      link: '/en/ai-lead-reactivation'
    },
    {
      icon: 'service-icon',
      title: 'Customer Retention',
      description: 'Proactive communication with existing customers. Follow-ups, satisfaction surveys, and retention.',
      roi: 'Better retention',
      metric: 'Personal approach',
      link: '/en/ai-customer-service'
    },
    {
      icon: 'sales-icon',
      title: 'Appointment Scheduling',
      description: 'Automatic calendar integration. Smart scheduling that takes into account preferences and availability.',
      roi: 'Save time',
      metric: 'No no-shows',
      link: '/en/ai-sales-agents'
    }
  ];
